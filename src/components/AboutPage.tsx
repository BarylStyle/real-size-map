...
import { ArrowLeft, MapPin, Globe, Move } from 'lucide-react';

export function AboutPage() {
  return (
    <div className="min-h-screen bg-[#121212]">
      {/* Header z przyciskiem powrotu */}
      <header className="bg-[#1e1e1e] shadow-sm border-b border-gray-700 sticky top-0 z-10">
        <div className="px-4 py-3 flex items-center gap-4">
          ...
          >
            ...
            <span className="font-medium">Powrót do mapy</span>
          </Link>
          <div className="flex-1">
            <h1 className="text-2xl md:text-3xl font-bold text-blue-300">O Projekcie</h1>
          </div>
        </div>
      </header>
